...
import torch
import re
from parsing import create_report
...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            # resize image
            #resized = cv2.resize(im0, dim)
            #cropped_image = resized[0:200, 1400:1900]
            #text = pytesseract.image_to_string(cropped_image)
            #cv2.imwrite("E:\\dev\Cropped_Image.jpg", cropped_image)
